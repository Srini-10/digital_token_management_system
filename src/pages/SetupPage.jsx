...
const DEPARTMENTS = [
    { department_name: 'RTO Office', office_location: 'Regional Transport Office, Anna Salai, Chennai', code: 'RTO' },
    { department_name: 'Revenue Office', office_location: 'District Collectorate, Rajaji Salai, Chennai', code: 'REV' },
    { department_name: 'Municipal Office', office_location: 'Ripon Building, Park Town, Chennai', code: 'MUN' },
    { department_name: 'Passport Seva', office_location: 'PSK Chennai, Kathipara Junction, Guindy', code: 'PSP' },
    { department_name: 'Aadhaar Centre', office_location: 'UIDAI Office, Haddows Road, Nungambakkam', code: 'ADH' },
    { department_name: 'Employment Office', office_location: 'District Employment Office, Egmore, Chennai', code: 'EMP' },
];
